...
void VSLAMCmw::SetUp(const std::string& config_file)
{
    ...
    // initialize subscribers and publishers
    {
        ...
        cmw_readers_writers_.point_feature_list_reader =
            bus_.AddReader<PointFeaturePtrList, BusType::DefaultConversionTraitsType<PointFeaturePtrList>>(
                topics.input_point_feature_list);
        ...
        cmw_readers_writers_.vehicle_pose_2d_writer =
            bus_.AddWriter<VehiclePose, BusType::DefaultConversionTraitsType<VehiclePose>>(topics.output_hpa_local);
