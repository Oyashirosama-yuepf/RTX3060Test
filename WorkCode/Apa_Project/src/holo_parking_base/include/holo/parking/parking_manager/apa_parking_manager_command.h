...
#ifndef HOLO_PARKING_BASE_APA_PARKING_MANAGER_COMMAND_H_
#define HOLO_PARKING_BASE_APA_PARKING_MANAGER_COMMAND_H_
...
class APAParkingManagerCommand
{
...
public:    /// 构造函数
    APAParkingManagerCommand() noexcept
      : time_stamp_()
      , event_id_(0)
      , enable_apa_(false)
...
public:   /// 析构函数
    ~APAParkingManagerCommand() = default;
...
#endif   /// HOLO_PARKING_BASE_APA_PARKING_MANAGER_COMMAND_H_
