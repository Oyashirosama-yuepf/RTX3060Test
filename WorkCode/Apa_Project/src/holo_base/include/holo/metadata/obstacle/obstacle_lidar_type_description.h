#ifndef HOLO_METADATA_OBSTACLE_OBSTACLE_LIDAR_TYPE_DESCRIPTION_H_
#define HOLO_METADATA_OBSTACLE_OBSTACLE_LIDAR_TYPE_DESCRIPTION_H_
...
{
static constexpr char OBSTACLE_LIDAR_SCALAR_TYPE_NAME[] = "ScalarType";
static constexpr char OBSTACLE_LIDAR_SIZE_FIELD_NAME[] = "num_contour_points";
}
template <typename T, size_t ALIGN, bool IS_BIG_ENDIAN>
struct TypeDescriptionResolver<holo::obstacle::ObstacleLidarT<T>, ALIGN, IS_BIG_ENDIAN>
{
    static TypeDescription::PtrType Get() noexcept
    {
        auto desc =
            std::make_shared<TypeDescriptionStruct>(ALIGN, IS_BIG_ENDIAN, "holo::obstacle::details::ObstacleLidarT");
        ...
        .SetMembers(
        {
            ...
            {"obstacle_exist_score", TypeDescriptionResolver<holo::float32_t, ALIGN, IS_BIG_ENDIAN>::Get()},
            {
                ...
                holo::geometry::Point3T<TypeReferenceTag<1U, obstacle_type::OBSTACLE_LIDAR_SCALAR_TYPE_NAME>>, ALIGN,
                        IS_BIG_ENDIAN >::Get()
            },
            {
                "relative_velocity",
                TypeDescriptionResolver <
                holo::numerics::VectorT<TypeReferenceTag<1U, obstacle_type::OBSTACLE_LIDAR_SCALAR_TYPE_NAME>, 3>,
            ...
            {"num_lidar_points", TypeDescriptionResolver<uint32_t, ALIGN, IS_BIG_ENDIAN>::Get()},
            {"num_contour_points", TypeDescriptionResolver<uint32_t, ALIGN, IS_BIG_ENDIAN>::Get()},
            {
                "contour_points",
                TypeDescriptionResolver <
                SequenceTag <
                holo::geometry::Point3T<TypeReferenceTag<2U, obstacle_type::OBSTACLE_LIDAR_SCALAR_TYPE_NAME>>,
                        ValueReferenceTag<1U, obstacle_type::OBSTACLE_LIDAR_SIZE_FIELD_NAME >>, ALIGN,
                        IS_BIG_ENDIAN >::Get()
            }});
        return desc;
    }
