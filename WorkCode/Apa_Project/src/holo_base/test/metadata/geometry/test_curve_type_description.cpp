...
/**
 * @file test_curve_type_description.cpp
 * @brief unit test for curve type descriptions
...
TEST(TypeDescription, CurveExplicit)
{
    auto desc = holo::metadata::TypeDescriptionResolver<CurveType>::Get();
