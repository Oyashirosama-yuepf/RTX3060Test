...
/**
 * @file tda4_decode_vx_context.h
 * @brief TDA4 Decode VX Context
 * @author zhangruiqiang(zhangruiqiang@holomatic.com).
 * @date 2021-11-12
 */

#ifndef _HOLO_SENSORS_CAMERA_IMAGE_SYNC_DECODE_H
#define _HOLO_SENSORS_CAMERA_IMAGE_SYNC_DECODE_H
...
namespace camera
{
class Tda4DecodeVxContext
{
public:
    Tda4DecodeVxContext(uint16_t refnum);
    vx_context GetContext() const noexcept;
    virtual ~Tda4DecodeVxContext();
