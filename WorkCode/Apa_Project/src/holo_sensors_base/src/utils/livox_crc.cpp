...
/**
 * @file livox_crc.cpp
 * @brief defines livox lidar crc alg
...
uint16_t CalcCRC16(const uint8_t* data, uint16_t len, uint16_t seed)
{
    ...
    {
        len -= 16;
        crc_n4(crc, ((const uint32_t*)data)[0], crc_table_mcrf4xx);
        crc_n4(crc, ((const uint32_t*)data)[1], crc_table_mcrf4xx);
        crc_n4(crc, ((const uint32_t*)data)[2], crc_table_mcrf4xx);
        crc_n4(crc, ((const uint32_t*)data)[3], crc_table_mcrf4xx);
        data += 16;
    }
...
uint32_t CalcCRC32(const uint8_t* data, uint16_t len, uint32_t seed)
{
    ...
    {
        len -= 16;
        crcsm_n4d(crc, ((const uint32_t*)data)[0], crc_table_crc32);
        crcsm_n4d(crc, ((const uint32_t*)data)[1], crc_table_crc32);
        crcsm_n4d(crc, ((const uint32_t*)data)[2], crc_table_crc32);
        crcsm_n4d(crc, ((const uint32_t*)data)[3], crc_table_crc32);
        data += 16;
    }
