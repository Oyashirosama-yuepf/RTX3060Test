...
/**
 * @file test_serializer_network_8.cpp
 * @brief Unit test for 84byte aligned network byte order serializer.
...
using Serializer      = holo::serialization::Serializer<true, 8>;
...
TEST(Serializer, serialize_i64_unaligned)
{
    ...
    for(uint8_t i = 0; i < 32; ++i)
    {
        ...
        ASSERT_EQ(((static_cast<uint64_t>(value)) & 0x00000000000000FF),       buffer[i * 8 + 7 + 8]);
        ASSERT_EQ(((static_cast<uint64_t>(value)) & 0x000000000000FF00) >> 8,  buffer[i * 8 + 6 + 8]);
        ASSERT_EQ(((static_cast<uint64_t>(value)) & 0x0000000000FF0000) >> 16, buffer[i * 8 + 5 + 8]);
        ASSERT_EQ(((static_cast<uint64_t>(value)) & 0x00000000FF000000) >> 24, buffer[i * 8 + 4 + 8]);
        ASSERT_EQ(((static_cast<uint64_t>(value)) & 0x000000FF00000000) >> 32, buffer[i * 8 + 3 + 8]);
        ASSERT_EQ(((static_cast<uint64_t>(value)) & 0x0000FF0000000000) >> 40, buffer[i * 8 + 2 + 8]);
        ASSERT_EQ(((static_cast<uint64_t>(value)) & 0x00FF000000000000) >> 48, buffer[i * 8 + 1 + 8]);
        ASSERT_EQ(((static_cast<uint64_t>(value)) & 0xFF00000000000000) >> 56, buffer[i * 8 + 0 + 8]); 
    }
    ser << holo::serialization::align;
...
TEST(Serializer, serialize_u64_unaligned)
{
    ...
    for(uint8_t i = 0; i < 32; ++i)
    {
        ...
        ASSERT_EQ((value & 0x00000000000000FF),       buffer[i * 8 + 7 + 8]);
        ASSERT_EQ((value & 0x000000000000FF00) >> 8,  buffer[i * 8 + 6 + 8]);
        ASSERT_EQ((value & 0x0000000000FF0000) >> 16, buffer[i * 8 + 5 + 8]);
        ASSERT_EQ((value & 0x00000000FF000000) >> 24, buffer[i * 8 + 4 + 8]);
        ASSERT_EQ((value & 0x000000FF00000000) >> 32, buffer[i * 8 + 3 + 8]);
        ASSERT_EQ((value & 0x0000FF0000000000) >> 40, buffer[i * 8 + 2 + 8]);
        ASSERT_EQ((value & 0x00FF000000000000) >> 48, buffer[i * 8 + 1 + 8]);
        ASSERT_EQ((value & 0xFF00000000000000) >> 56, buffer[i * 8 + 0 + 8]); 
    }
    ser << holo::serialization::align;
    ASSERT_EQ(264, ser.GetSize());
...
TEST(Serializer, serialize_f64)
{
    ...
    for(uint8_t i = 0; i < 32; ++i)
    {
        ...
        value0   = (value0 << 56) | 
                   ((value0 & 0x000000000000FF00) << 40) | 
                   ((value0 & 0x0000000000FF0000) << 24) | 
                   ((value0 & 0x00000000FF000000) << 8) | 
                   ((value0 & 0x000000FF00000000) >> 8) | 
                   ((value0 & 0x0000FF0000000000) >> 24) | 
                   ((value0 & 0x00FF000000000000) >> 40) | 
                   (value0 >> 56) ;
        ...
        value1   = (value1 << 56) | 
                   ((value1 & 0x000000000000FF00) << 40) | 
                   ((value1 & 0x0000000000FF0000) << 24) | 
                   ((value1 & 0x00000000FF000000) << 8) | 
                   ((value1 & 0x000000FF00000000) >> 8) | 
                   ((value1 & 0x0000FF0000000000) >> 24) | 
                   ((value1 & 0x00FF000000000000) >> 40) | 
                   (value1 >> 56) ;
...
TEST(Serializer, serialize_f64_unaligned)
{
    ...
    for(uint8_t i = 0; i < 32; ++i)
    {
        ...
        uint64_t        value0          = *(reinterpret_cast<uint64_t const*>(ser.GetData() + 8 * i + 8));
        value0   = (value0 << 56) | 
                   ((value0 & 0x000000000000FF00) << 40) | 
                   ((value0 & 0x0000000000FF0000) << 24) | 
                   ((value0 & 0x00000000FF000000) << 8) | 
        ...
        holo::float64_t*  f_ptr_0         = reinterpret_cast<holo::float64_t*>(&value0);
        holo::float64_t   expected_value0 = *f_ptr_0;
        uint64_t        value1          = *(reinterpret_cast<uint64_t const*>(buffer + 8 * i + 8));
        value1   = (value1 << 56) | 
                   ((value1 & 0x000000000000FF00) << 40) | 
                   ((value1 & 0x0000000000FF0000) << 24) | 
                   ((value1 & 0x00000000FF000000) << 8) | 
...
TEST(Serializer, tail_align)
{
    ...
    Serializer ser(buffer, 1024);
    ASSERT_EQ(0, ser.GetSize());
    ser << static_cast<uint64_t>(4) << 'a' << 'b' << 'c';
...
TEST(Serializer, serialize_prealign_custom_object)
{
    ...
    ASSERT_EQ(0x12, buffer[8]);
    ASSERT_EQ(0x34, buffer[9]);
    ASSERT_EQ(0x56, buffer[10]);
    ASSERT_EQ(0x78, buffer[11]);
    ASSERT_EQ(0x87, buffer[12]);
    ASSERT_EQ(0x65, buffer[13]);
    ASSERT_EQ(0x43, buffer[14]);
    ASSERT_EQ(0x21, buffer[15]);
