...
# The following environment variables affect the output of this script.
#
...
#
# The following cmake variables affect the output of this script.
#    HOLO_PYTHON_VERSION   -- python version used for build projects
#
# The script defines following variables:
#
...
if(NOT HOLO_PROJECT_CONFIGURATION_SET)
    ...
    set(CMAKE_PREFIX_PATH ${HOLO_ROOT};${HOLO_3RDPARTY_ROOT};${HOLO_ROOT}/../host;$ENV{CMAKE_PREFIX_PATH})
    ...
    if(HOLO_BUILD_PROFILE)
        if(CMAKE_SYSTEM_NAME STREQUAL "QNX")
            #set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -finstrument-functions -finstrument-functions-exclude-file-list=usr/lib")
            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -finstrument-functions -finstrument-functions-exclude-file-list=usr/lib")
            LINK_LIBRARIES(profilingS)
        else()
            set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -finstrument-functions -finstrument-functions-exclude-file-list=usr/lib")
            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -finstrument-functions -finstrument-functions-exclude-file-list=usr/lib")
        endif()
    ...
    if(HOLO_BUILD_COVERAGE)
        ...
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DNDEBUG --coverage")
    endif()

    set(HOLO_PROJECT_CONFIGURATION_SET 1)
