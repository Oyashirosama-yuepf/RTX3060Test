...
template <>
struct DefaultMessageTraits<::holo_parking_msg::planning::PathAttribute>
{
    using ValueType   = ::holo_parking_msg::planning::PathAttribute;
    using MessageType = ::holo_parking_msg::planning::PathAttribute;
};
