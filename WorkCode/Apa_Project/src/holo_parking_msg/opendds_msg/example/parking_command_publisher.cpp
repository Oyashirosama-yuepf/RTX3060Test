...
{
    std::cout << "./parking_command_publisher domain_id value" << '\n';
    ...
    BusType::Initialize(argc, argv, std::string("parking_command_publisher"));
    ...
    auto    writer = bus.AddWriter<uint32_t>("/holo/planning/parking_command");
