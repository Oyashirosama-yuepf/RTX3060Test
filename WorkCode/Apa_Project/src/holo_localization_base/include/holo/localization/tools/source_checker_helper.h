...
/**
 * @brief define the configuration of roadframe unique checker
 */
struct RoadFrameCheckerUniqueParameters
{
    uint8_t detected_lane_confidence_threshold;  /* lane boundary confidence threshold in road frame */
...
/**
 * @brief check roadframe unique state
 * @param params roadframe unique checker configuration
 * @param roadframe measurment of roadframe
 * @return true if the measured value meets the requirements
 */
