...
/**
 * @file point2point_factor_inl.h
 * @brief This header file defines point2point factor
 * @author mengzhili(mengzhili@holomaitc.com)
 * @date 2021-03-31
 */
#ifndef HOLO_LOCALIZATION_SAM_FACTORS_INTERNAL_POINT2POINT_FACTOR_INL_H_
#define HOLO_LOCALIZATION_SAM_FACTORS_INTERNAL_POINT2POINT_FACTOR_INL_H_
...
/**
 * @brief Point2Point factor defines point to point distance error
 * @details error =||(T_wb.TransformFrom(pt_src) - pt_tgt)||
 */
class Point2PointFactor : public gtsam::NoiseModelFactor1<gtsam::Pose3>
{
public:
    /**
    ...
    using Ptr      = boost::shared_ptr<Point2PointFactor>;
    using ConstPtr = boost::shared_ptr<const Point2PointFactor>;

    /**
     * @brief Construct a new Plane Factor object
     *
     * @param[in] pose_key key of the pose to be optimized, eg. T_wb
     ...
     */
    Point2PointFactor(gtsam::Key const& pose_key, gtsam::Point3 const& source_pt, gtsam::Point3 const& target_pt,
     ...
     *
     */
    virtual ~Point2PointFactor() noexcept;
...
#endif  // HOLO_LOCALIZATION_SAM_FACTORS_INTERNAL_POINT2POINT_FACTOR_INL_H_
