...
/**
 * @file intrinsic_yaml_node_convert.h
 * @brief This header file define the convert between camera intrinsic and yaml node
 * @author Guo Peikai(guopeikai@holomatic.com)
 * @date 2021-12-08
 */

#ifndef HOLO_IO_LOCALIZATION_VISION_VSLAM_INTRINSIC_H_
#define HOLO_IO_LOCALIZATION_VISION_VSLAM_INTRINSIC_H_
...
{
template <typename T>
struct convert<holo::localization::vision::vslam::PinholeIntrinsicT<T>>
{
    using ScalarType = T;
    using ValueType  = holo::localization::vision::vslam::PinholeIntrinsicT<ScalarType>;
    using Model      = typename holo::localization::vision::vslam::CameraIntrinsicBaseT<ScalarType>::Model;
...
template <typename T>
struct convert<holo::localization::vision::vslam::FisheyeIntrinsicT<T>>
{
    using ScalarType = T;
    using ValueType  = holo::localization::vision::vslam::FisheyeIntrinsicT<ScalarType>;
    using Model      = typename holo::localization::vision::vslam::CameraIntrinsicBaseT<ScalarType>::Model;
...
///////////////////////////////////////////////////
template <typename T>
struct convert<holo::localization::vision::vslam::OmnidirectionalIntrinsicT<T>>
{
    using ScalarType = T;
    using ValueType  = holo::localization::vision::vslam::OmnidirectionalIntrinsicT<ScalarType>;
    using Model      = typename holo::localization::vision::vslam::CameraIntrinsicBaseT<ScalarType>::Model;
