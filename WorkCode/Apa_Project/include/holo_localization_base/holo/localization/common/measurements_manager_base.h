...
public:
    ...
    const static std::size_t kCameraLaneBoundariesBufferSize = 100u;
    ...
    using CameraLaneBoundariesBufferType = OrderedBuffer<CameraLaneBoundariesType, kCameraLaneBoundariesBufferSize, 
                                           StampedTimeCompareT<CameraLaneBoundariesType> >;
    ...
    /**
     * @brief add CameraLaneBoundaries measurements
     *
     * @param m CameraLaneBoundaries measurement
     * @return bool_t it returns false when fails to add the measurement
     */
    virtual bool_t AddMeasurement(const CameraLaneBoundariesType& m);
    ...
    /**
     * @brief get latest CameraLaneBoundaries of the queue
     *
     * @param m CameraLaneBoundaries measurement
     * @return bool_t it returns false when fails to find such a measurement
     */
    virtual bool_t GetLatestMeasurement(CameraLaneBoundariesType& m);
    ...
    /**
     * @brief get and pop oldest CameraLaneBoundaries of the queue
     *
     * @param m CameraLaneBoundaries measurement
     * @return bool_t it returns false when fails to find such a measurement
     */
    virtual bool_t GetAndPopOldestMeasurement(CameraLaneBoundariesType& m);
    ...
    /**
     * @brief Get CameraLaneBoundaries between two timestamps
     *
     * @param left left timestamp
     * @param right right timestamp
     * @param camera_lane_boundaries CameraLaneBoundaries measurements
     * @return bool_t it returns false when fails to find such measurements
     */
    virtual bool_t GetMeasurementsBetween(const Timestamp& left, const Timestamp& right,
                                          std::vector<CameraLaneBoundariesType>& camera_lane_boundaries);
    ...
    /**
     * @brief return CameraLaneBoundaries number
     */
    inline uint16_t GetCameraLaneBoundariesNum() const
    {
        return static_cast<uint16_t>(camera_lane_boundaries_buffer_.size());
    }
...
protected:
    ...
    std::mutex camera_lane_boundaries_buffer_mutex_;
    ...
    CameraLaneBoundariesBufferType camera_lane_boundaries_buffer_;
