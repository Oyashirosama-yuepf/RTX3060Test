...
public:
    ...
    /**
     * @brief Set the Map retriever object, used to obtian map data
     *
     * @param map_retriever
     */
    virtual void SetMapRetriever(holo::parking::map::ParkingLocalizationRetriever* map_retriever) override;
