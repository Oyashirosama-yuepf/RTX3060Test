...
#ifndef HOLO_LOCALIZATION_VISION_VSLAM_SEMANTIC_HUNGARIAN_OPTIMIZER_H_
#define HOLO_LOCALIZATION_VISION_VSLAM_SEMANTIC_HUNGARIAN_OPTIMIZER_H_
 ...
 *
 * @details the implementation is originated from holo_perception_base (@holo_perception) with minor change that adapts
 * to the framework in semantic localization, thanks for the hardworking and general sharing of perception folks.
 *
...
{
public:
    using TAtype = int32_t;  ///< data type of assignment vector
    using TDtype = Scalar;   ///< data type of distance matrix
...
#endif  // HOLO_LOCALIZATION_VISION_VSLAM_SEMANTIC_HUNGARIAN_OPTIMIZER_H_