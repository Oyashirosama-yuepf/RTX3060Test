...
#include <holo/parking/map/parking_localization_retriever.h>
...
public:
    ...
    /**
     * @brief set map retriever, used to obtian map data
     */
    virtual void SetMapRetriever(holo::parking::map::ParkingLocalizationRetriever* map_retriever)
    {
        map_retriever_ = map_retriever;
    };
...
protected:
    ...
    int64_t             last_point_feature_timestamp_    = -1;
    int64_t             last_imu_timestamp_              = -1;
    int64_t             last_chassis_timestamp_          = -1;
    int64_t             last_parking_slot_msg_timestamp_ = -1;
    ...
    ///@brief used to obtian map data
    holo::parking::map::ParkingLocalizationRetriever* map_retriever_;
