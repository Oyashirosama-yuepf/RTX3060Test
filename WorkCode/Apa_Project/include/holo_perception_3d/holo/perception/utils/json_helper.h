...
public:
    ...
    /**
     * @brief get intrinsic k value
     *
     * @return std::string const&
     */
    std::string const& GetK() const
    {
        return meta_info_.Kstr;
    }

    /**
     * @brief get distortion d value
     *
     * @return std::string const&
     */
    std::string const& GetD() const
    {
        return meta_info_.Dstr;
    }

    /**
     * @brief Get the Camera Name object
     *
     * @return std::string const&
     */
    std::string const& GetCameraName() const
    {
        return meta_info_.camera_name;
    }
