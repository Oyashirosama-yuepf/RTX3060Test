...
#include "holo/perception/inference/tidl/app_nms.h"
#include "sys/time.h"
...
public:
    ...
    // od fd node
    int tidl_node_num;
    PreProcObj preProcObj_arr[APP_TIDL_NODE_NUM];  
    TIDLObj tidlObj_arr[APP_TIDL_NODE_NUM];        
    ...
    AppSelfKernel*                  AppSelfKernelTest;
...
// void app_parse_cmd_line_args(AppObj *obj, vx_int32 argc, vx_char *argv[]);
// void add_graph_parameter_by_node_index(vx_graph graph, vx_node node, vx_uint32 node_parameter_index);
// void app_pipeline_params_defaults(AppObj *obj);
// void app_find_object_array_index(vx_object_array object_array[], vx_reference ref, vx_int32 array_size, vx_int32
// *array_idx); void read_det_result(AppObj *obj, TIDL_outArgs *quantscale, vx_int32 frame_id);
...
// // void display_convert_data(sTIDL_IOBufDesc_t *ioBufDesc, vx_tensor *output_tensors, char* output_file_name,
// TIDL_outArgs *quantscale); void displayOutput(sTIDL_IOBufDesc_t *ioBufDesc, vx_tensor *output_tensors, char*
// output_file_name, TIDL_outArgs *quantscale); int get_inference_data(sTIDL_IOBufDesc_t *ioBufDesc, vx_tensor
// *output_tensors, TIDL_outArgs *quantscale, float* featuremap_data); vx_size getTensorDataType(vx_int32 tidl_type);
