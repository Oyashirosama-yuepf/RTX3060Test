/*!
 *  \brief argmax layer for TensorRT
 *  \author wentian
 *  \date 2019-01-01
...
#ifndef HOLO_PERCEPTION_DETECTION_TENSORRT_PLUGIN_LAYERS_ARGMAX_LAYER_H_
#define HOLO_PERCEPTION_DETECTION_TENSORRT_PLUGIN_LAYERS_ARGMAX_LAYER_H_
...
class ArgmaxLayer : public nvinfer1::IPluginExt
{
public:
    ...
    ArgmaxLayer(const void* data, size_t length);

    virtual ~ArgmaxLayer() = default;
    ...
    {
        return sizeof(input_dim_) + sizeof(data_type_);
    }
...
#endif  /// HOLO_PERCEPTION_DETECTION_TENSORRT_PLUGIN_LAYERS_ARGMAX_LAYER_H_
