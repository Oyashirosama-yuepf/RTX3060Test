...
/**
 * @file eol_surround_camera_data_container.h
 * @brief data container for surround camera calibration
 * @author jiaxing zhao(zhaojiaxing@holomaitc.com)
 * @date "2021-07-30"
 */

#ifndef HOLO_CALIBRATION_CAMERA_FIELD_EOL_SURROUND_CAMERA_DATA_CONTAINER_H_
#define HOLO_CALIBRATION_CAMERA_FIELD_EOL_SURROUND_CAMERA_DATA_CONTAINER_H_
 ...
 */
class EOLSurroundCameraDataContainer
{
public:
     ...
     */
    EOLSurroundCameraDataContainer();
     ...
     */
    void SetAprilTagDatabase(AprilTagDatabasePtr const& apriltag_db_ptr)
    {
        apriltag_db_ptr_ = apriltag_db_ptr;
...
protected:
     ...
     * @param[in] apriltag_db_ptr Shared pointer of AprilTagDatabase, which should be generated using
     *                            the specified application "generate_apriltag_database"
     ...
     */
    void processApriltagTags(AprilTagDatabasePtr const& apriltag_db_ptr, cv::Mat const& gray_image,
                             std::vector<cv::Point2f>& vpoint2_pixel, std::vector<cv::Point2f>& vpoint2_world) const;
...
private:
    ...
    /**
     * @brief pointer of apriltag database
     *
     */
    AprilTagDatabasePtr apriltag_db_ptr_;
...
#endif  // HOLO_CALIBRATION_CAMERA_FIELD_EOL_SURROUND_CAMERA_DATA_CONTAINER_H_