...
#ifndef HOLO_CALIBRATION_CAMERA_FIELD_EOL_PROJECT_EOL_SURROUND_CAMERA_CALIBRATION_VISUALIZE_H_
#define HOLO_CALIBRATION_CAMERA_FIELD_EOL_PROJECT_EOL_SURROUND_CAMERA_CALIBRATION_VISUALIZE_H_
 ...
 */
class EOLCalibrateSurroundCameraVisualize
{
public:
     ...
     */
    EOLCalibrateSurroundCameraVisualize(std::vector<EOLSurroundCameraCalibrationDataContainer> const& containers);

    /**
     * @brief Destroy the Surround Camera Calibration object
     *
     */
    ~EOLCalibrateSurroundCameraVisualize();
...
private:
    std::vector<EOLSurroundCameraCalibrationDataContainer> containers_;  ///< data contaienrs
...
#endif  // HOLO_CALIBRATION_CAMERA_FIELD_EOL_PROJECT_EOL_SURROUND_CAMERA_CALIBRATION_VISUALIZE_H_