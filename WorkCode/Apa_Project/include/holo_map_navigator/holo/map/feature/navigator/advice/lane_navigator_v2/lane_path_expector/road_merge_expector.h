...
#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_ROAD_MERGE_EXPECTOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_ROAD_MERGE_EXPECTOR_H_
...
namespace advice
{
class RoadMergeExpector : public ExpectorBase
{
public:
    RoadMergeExpector(SceneSketchSPtrType scene_sketch);
    virtual ~RoadMergeExpector() = default;
