...
#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_SCENE_ANALYZER_ROAD_MERGE_ANALYZER_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_SCENE_ANALYZER_ROAD_MERGE_ANALYZER_H_
 ...
 */
class MergeAnalyzer : public SceneAnalyzer
{
public:
    /**
