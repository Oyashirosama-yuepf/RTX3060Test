...
/**
 * @file split_generator.h
 * @brief Generate lane path for lane-level navigation
 * @author yuhongbo (yuhongbo@holomatic.com)
 * @date 2022-3-7
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_ANALYSIS_LANE_ITEM_SPLIT_GENERATOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_ANALYSIS_LANE_ITEM_SPLIT_GENERATOR_H_
...
namespace lanepath
{
class LaneItemSplitGenerator : public LaneItemGeneratorBase
{
public:
    /**
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_ANALYSIS_LANE_ITEM_SPLIT_GENERATOR_H_ */