...
/**
 * @file road_split_expector.h
 * @brief Expected is used to recommend lane paths going through break lane
 * @author yuhongbo (yuhongbo@holomatic.com)
 * @date 2022-02-24
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_ROAD_SPLIT_EXPECTOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_ROAD_SPLIT_EXPECTOR_H_
...
namespace advice
{
class RoadSplitExpector : public ExpectorBase
{
public:
    RoadSplitExpector(SceneSketchSPtrType scene_sketch);
    virtual ~RoadSplitExpector() = default;
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_ROAD_SPLIT_EXPECTOR_H_ */