...
#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_SCENE_ANALYZER_BREAK_LANE_ANALYZER_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_SCENE_ANALYZER_BREAK_LANE_ANALYZER_H_
 ...
 *
 */
class BreakLaneAnalyzer : public SceneAnalyzer
{
public:
    BreakLaneAnalyzer()                         = default;
    ~BreakLaneAnalyzer()                        = default;
    BreakLaneAnalyzer(BreakLaneAnalyzer const&) = default;
    BreakLaneAnalyzer& operator=(BreakLaneAnalyzer const&) = default;
    BreakLaneAnalyzer(BreakLaneAnalyzer&&)                 = default;
    BreakLaneAnalyzer& operator=(BreakLaneAnalyzer&&) = default;
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_SCENE_ANALYZER_BREAK_LANE_ANALYZER_H_ */