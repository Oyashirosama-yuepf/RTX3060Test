...
/**
 * @file road_merge_constraint.h
 * @brief Generate lane path for lane-level navigation
 * @author yuhongbo (yuhongbo@holomatic.com)
 * @date 2022-3-7
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_ANALYSIS_CONSTRAINT_ROAD_MERGE_CONSTRAINT_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_ANALYSIS_CONSTRAINT_ROAD_MERGE_CONSTRAINT_H_
...
namespace lanepath
{
class RoadMergeConstraint : public ConstraintBase
{
public:
...
private:
    holo::bool_t isRouteMergeRight(holo::bool_t& is_right_merge);
    holo::bool_t isRouteMergeLeft(holo::bool_t& is_left_merge);
    holo::bool_t isLaneSplit(LaneItemSPtrType const in_lane_item,
        holo::bool_t& is_left_merge, holo::bool_t& is_right_merge);
    holo::bool_t match(LaneItemSPtrType const& lane_item_to_match, 
        holo::bool_t& in_scope, holo::bool_t& in_route_branch, SceneSketchSPtrType& relate_scene);
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_ANALYSIS_CONSTRAINT_ROAD_MERGE_CONSTRAINT_H_ */