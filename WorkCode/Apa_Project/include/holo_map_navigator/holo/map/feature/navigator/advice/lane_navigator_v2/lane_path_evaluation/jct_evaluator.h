...
/**
 * @file jct_evaluator.h
 * @brief The evaulator is used to score by jct scene
 * @author yuhongbo (yuhongbo@holomatic.com)
 * @date 2022-02-24
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_JCT_EVALUATOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_JCT_EVALUATOR_H_
...
namespace advice
{
class JCTEvaluator : public EvaluatorBase
{
public:
    JCTEvaluator(SceneSketchSPtrType scene_sketch);
