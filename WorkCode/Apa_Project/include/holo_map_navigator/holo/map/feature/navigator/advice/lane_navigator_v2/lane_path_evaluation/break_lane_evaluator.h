...
/**
 * @file break_lane_evaluator.h
 * @brief Expected is used to recommend lane paths going through break lane
 * @author yuhongbo (yuhongbo@holomatic.com)
 * @date 2022-02-24
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_BREAK_LANE_EVALUATOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_BREAK_LANE_EVALUATOR_H_
...
namespace advice
{
class BreakLaneEvaluator : public EvaluatorBase
{
public:
    BreakLaneEvaluator(SceneSketchSPtrType scene_sketch);
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_BREAK_LANE_EVALUATOR_H_ */