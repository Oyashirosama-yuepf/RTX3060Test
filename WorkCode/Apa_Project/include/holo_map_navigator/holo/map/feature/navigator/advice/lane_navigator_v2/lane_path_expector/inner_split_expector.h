...
/**
 * @file inner_split_expector.h
 * @brief Expected is used to recommend lane paths going through certain link
 * @author yuhongbo (yuhongbo@holomatic.com)
 * @date 2022-02-24
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_INNER_SPLIT_EXPECTOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_INNER_SPLIT_EXPECTOR_H_
...
namespace advice
{
class InnerSplitExpector : public ExpectorBase
{
public:
    InnerSplitExpector(SceneSketchSPtrType scene_sketch);
    virtual ~InnerSplitExpector() = default;
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_INNER_SPLIT_EXPECTOR_H_ */