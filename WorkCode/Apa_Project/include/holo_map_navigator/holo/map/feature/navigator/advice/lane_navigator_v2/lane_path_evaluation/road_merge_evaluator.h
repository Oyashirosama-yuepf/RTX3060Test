...
/**
 * @file road_merge_evaluator.h
 * @brief Expected is used to recommend lane paths going through scene of road-merging
 * @author yuhongbo (yuhongbo@holomatic.com)
 * @date 2022-02-24
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_ROAD_MERGE_EVALUATOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_ROAD_MERGE_EVALUATOR_H_
...
namespace advice
{
class RoadMergeEvaluator : public EvaluatorBase
{
public:
    RoadMergeEvaluator(SceneSketchSPtrType scene_sketch);
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_ROAD_MERGE_EVALUATOR_H_ */