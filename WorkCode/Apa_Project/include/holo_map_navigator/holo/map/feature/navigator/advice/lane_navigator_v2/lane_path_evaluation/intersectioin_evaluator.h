...
/**
 * @file intersection_evaluator.h
 * @brief The evaulator is used to score by intersection scene
 * @author yuhongbo (yuhongbo@holomatic.com)
 * @date 2022-02-24
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_INTERSECTION_EVALUATOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_INTERSECTION_EVALUATOR_H_
...
namespace advice
{
class IntersectionEvaluator : public EvaluatorBase
{
public:
    IntersectionEvaluator(SceneSketchSPtrType scene_sketch);
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_INTERSECTION_EVALUATOR_H_ */