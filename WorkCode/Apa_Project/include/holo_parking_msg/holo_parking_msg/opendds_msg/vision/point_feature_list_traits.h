...
#ifndef HOLO_PARKING_MSG_OPENDDS_MSG_VISION_POINT_FEATURELIST_TRAITS_H_
#define HOLO_PARKING_MSG_OPENDDS_MSG_VISION_POINT_FEATURELIST_TRAITS_H_
...
#include <holo_parking_msg/vision/PointFeaturefListC.h>
#include <holo_parking_msg/vision/PointFeaturefListS.h>
#include <holo_parking_msg/vision/PointFeaturefListTypeSupportImpl.h>
#include <holo_parking_msg/vision/PointFeaturefS.h>
#include <holo_parking_msg/vision/PointFeaturefTypeSupportImpl.h>
...
template <>
struct DefaultMessageTraits<::holo_parking_msg::vision::PointFeaturef>
{
    using ValueType   = ::holo_parking_msg::vision::PointFeaturef;
    using MessageType = ::holo_parking_msg::vision::PointFeaturef;
};
...
template <>
struct DefaultMessageTraits<::holo_parking_msg::vision::PointFeaturefList>
{
    using ValueType   = ::holo_parking_msg::vision::PointFeaturefList;
    using MessageType = ::holo_parking_msg::vision::PointFeaturefList;
};
...
struct DefaultConversionTraits<::holo::parking::vision::PointFeaturePtrListf>
{
    ...
    static void Convert(ValueType const& value, MessageType& message)
    {
        ...
        for (size_t i = 0; i < value.GetPointFeatureList().size(); ++i)
        {
            ...
            opendds_wrapper::DefaultConversionTraits<::holo::parking::vision::PointFeaturef>::Convert(
    ...
    static void Convert(MessageType const& message, ValueType& value)
    {
        ...
        for (size_t i = 0; i < message.point_feature_list.length(); ++i)
        {
