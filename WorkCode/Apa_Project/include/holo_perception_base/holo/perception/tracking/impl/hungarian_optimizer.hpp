...
const TDtype HungarianOptimizer<TAtype, TDtype>::INF_VALUE_FACTOR = static_cast<TDtype>(10);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
const TDtype HungarianOptimizer<TAtype, TDtype>::DIST_INF_VALUE = std::numeric_limits<TDtype>::infinity();

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
const TAtype HungarianOptimizer<TAtype, TDtype>::UNASSIGNED_VALUE = static_cast<TAtype>(-1);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
std::vector<TAtype> HungarianOptimizer<TAtype, TDtype>::FindOptimalAssignment(
    const numerics::MatrixXT<TDtype>& dist_matrix_in, TMethod method)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
TDtype HungarianOptimizer<TAtype, TDtype>::AssignOptimal(const numerics::MatrixXT<TDtype>& dist_matrix_in)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::InitDistMatrix(const numerics::MatrixXT<TDtype>& dist_matrix_in)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
bool_t HungarianOptimizer<TAtype, TDtype>::FindMaxFiniteValueInDistMatrix(TDtype& max_finite_value)
{
    max_finite_value            = -1;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::ReplaceInfiniteValueInDistMatrix(const TDtype max_finite_value)
{
    // set all infinite elements to big finite value
    TDtype inf_value;
    if (max_finite_value > static_cast<TDtype>(0))
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::SubtractMinValueEachRow()
{
    TDtype min_value;
    for (DimType row = 0U; row < num_rows_; row++)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::CoverColumnZeros()
{
    // steps 1 and 2a
    for (DimType row = 0U; row < num_rows_; row++)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::SubtractMinValueEachColumn()
{
    TDtype min_value;
    for (DimType col = 0U; col < num_cols_; col++)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::CoverRowZeros()
{
    // Steps 1 and 2a
    for (DimType col = 0U; col < num_cols_; col++)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::BuildAssignmentVector()
{
    for (DimType row = 0U; row < num_rows_; row++)
    {
        for (DimType col = 0U; col < num_cols_; col++)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
TDtype HungarianOptimizer<TAtype, TDtype>::ComputeAssignmentCost(const holo::numerics::MatrixXT<TDtype>& dist_matrix)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::Step2a()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::Step2b()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::Step3()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::Step4(const DimType row, const DimType col)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::Step5()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
bool HungarianOptimizer<TAtype, TDtype>::IsFinite(const TDtype value)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::AddBlockToMatrix(const MatrixBlockType& added_block, const DimType i,
                                                          const DimType j, const DimType rows, const DimType cols,
                                                          numerics::MatrixXT<TDtype>& matrix)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
TDtype HungarianOptimizer<TAtype, TDtype>::AssignSubOptimalV1(const numerics::MatrixXT<TDtype>& dist_matrix_in)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
TDtype HungarianOptimizer<TAtype, TDtype>::AssignSubOptimalV2(const numerics::MatrixXT<TDtype>& dist_matrix_in)
{
    suboptimal_cost_ = static_cast<TDtype>(0);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::ComputeNumOfValidation(std::vector<bool_t>& is_value_found_)
{
    for (DimType row = 0U; row < num_rows_; row++)
    {
        for (DimType col = 0U; col < num_cols_; col++)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::AssignSingleValidObservation(bool_t& repeat_steps)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::AssignSingleValidTrack(bool_t& repeat_steps)
{
    if (num_cols_ > 1)
    {
        for (size_t row = 0U; row < num_rows_; row++)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::ChooseMinDistanceObservation()
{
    for (size_t row = 0U; row < num_rows_; row++)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::ChooseMinDistanceTrack()
{
    for (size_t col = 0U; col < num_cols_; col++)
    {
        if (num_tracks_[col] > 1)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TAtype, typename TDtype>
void HungarianOptimizer<TAtype, TDtype>::FindMinAndAssign()
{
    for (;;)
    {
