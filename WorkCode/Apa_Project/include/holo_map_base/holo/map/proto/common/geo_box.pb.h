...
// source: holo/map/proto/common/geo_box.proto

#ifndef PROTOBUF_INCLUDED_holo_2fmap_2fproto_2fcommon_2fgeo_5fbox_2eproto
#define PROTOBUF_INCLUDED_holo_2fmap_2fproto_2fcommon_2fgeo_5fbox_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_holo_2fmap_2fproto_2fcommon_2fgeo_5fbox_2eproto 

namespace protobuf_holo_2fmap_2fproto_2fcommon_2fgeo_5fbox_2eproto {
...
namespace google {
namespace protobuf {
template<> ::holo::map::proto::common::GeoBox* Arena::CreateMaybeMessage<::holo::map::proto::common::GeoBox>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace holo {
namespace map {
...
class GeoBox : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:holo.map.proto.common.GeoBox) */ {
 public:
  GeoBox();
  virtual ~GeoBox();
  ...
  inline GeoBox* New() const final {
    return CreateMaybeMessage<GeoBox>(NULL);
  }

  GeoBox* New(::google::protobuf::Arena* arena) const final {
  ...
  // optional .holo.map.proto.common.GeoPoint right_forward_top = 2;
  bool has_right_forward_top() const;
  void clear_right_forward_top();
  static const int kRightForwardTopFieldNumber = 2;
  private:
  ...
  // @@protoc_insertion_point(class_scope:holo.map.proto.common.GeoBox)
 private:
  ...
  friend struct ::protobuf_holo_2fmap_2fproto_2fcommon_2fgeo_5fbox_2eproto::TableStruct;
};
// ===================================================================
...
// optional .holo.map.proto.common.GeoPoint left_back_bottom = 1;
inline bool GeoBox::has_left_back_bottom() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void GeoBox::set_has_left_back_bottom() {
  _has_bits_[0] |= 0x00000001u;
}
inline void GeoBox::clear_has_left_back_bottom() {
  _has_bits_[0] &= ~0x00000001u;
}
inline const ::holo::map::proto::common::GeoPoint& GeoBox::_internal_left_back_bottom() const {
  return *left_back_bottom_;
}
inline const ::holo::map::proto::common::GeoPoint& GeoBox::left_back_bottom() const {
  const ::holo::map::proto::common::GeoPoint* p = left_back_bottom_;
  // @@protoc_insertion_point(field_get:holo.map.proto.common.GeoBox.left_back_bottom)
  return p != NULL ? *p : *reinterpret_cast<const ::holo::map::proto::common::GeoPoint*>(
      &::holo::map::proto::common::_GeoPoint_default_instance_);
}
inline ::holo::map::proto::common::GeoPoint* GeoBox::release_left_back_bottom() {
  // @@protoc_insertion_point(field_release:holo.map.proto.common.GeoBox.left_back_bottom)
  clear_has_left_back_bottom();
  ::holo::map::proto::common::GeoPoint* temp = left_back_bottom_;
  left_back_bottom_ = NULL;
  return temp;
}
inline ::holo::map::proto::common::GeoPoint* GeoBox::mutable_left_back_bottom() {
  ...
  // @@protoc_insertion_point(field_mutable:holo.map.proto.common.GeoBox.left_back_bottom)
  return left_back_bottom_;
}
inline void GeoBox::set_allocated_left_back_bottom(::holo::map::proto::common::GeoPoint* left_back_bottom) {
  ...
  // @@protoc_insertion_point(field_set_allocated:holo.map.proto.common.GeoBox.left_back_bottom)
}

// optional .holo.map.proto.common.GeoPoint right_forward_top = 2;
inline bool GeoBox::has_right_forward_top() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void GeoBox::set_has_right_forward_top() {
  _has_bits_[0] |= 0x00000002u;
}
inline void GeoBox::clear_has_right_forward_top() {
  _has_bits_[0] &= ~0x00000002u;
}
inline const ::holo::map::proto::common::GeoPoint& GeoBox::_internal_right_forward_top() const {
  return *right_forward_top_;
}
inline const ::holo::map::proto::common::GeoPoint& GeoBox::right_forward_top() const {
  const ::holo::map::proto::common::GeoPoint* p = right_forward_top_;
  // @@protoc_insertion_point(field_get:holo.map.proto.common.GeoBox.right_forward_top)
  return p != NULL ? *p : *reinterpret_cast<const ::holo::map::proto::common::GeoPoint*>(
      &::holo::map::proto::common::_GeoPoint_default_instance_);
}
inline ::holo::map::proto::common::GeoPoint* GeoBox::release_right_forward_top() {
  // @@protoc_insertion_point(field_release:holo.map.proto.common.GeoBox.right_forward_top)
  clear_has_right_forward_top();
  ::holo::map::proto::common::GeoPoint* temp = right_forward_top_;
  right_forward_top_ = NULL;
  return temp;
}
inline ::holo::map::proto::common::GeoPoint* GeoBox::mutable_right_forward_top() {
  set_has_right_forward_top();
  if (right_forward_top_ == NULL) {
    auto* p = CreateMaybeMessage<::holo::map::proto::common::GeoPoint>(GetArenaNoVirtual());
    right_forward_top_ = p;
  }
  // @@protoc_insertion_point(field_mutable:holo.map.proto.common.GeoBox.right_forward_top)
  return right_forward_top_;
}
inline void GeoBox::set_allocated_right_forward_top(::holo::map::proto::common::GeoPoint* right_forward_top) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:holo.map.proto.common.GeoBox.right_forward_top)
}
...
#endif  // PROTOBUF_INCLUDED_holo_2fmap_2fproto_2fcommon_2fgeo_5fbox_2eproto
