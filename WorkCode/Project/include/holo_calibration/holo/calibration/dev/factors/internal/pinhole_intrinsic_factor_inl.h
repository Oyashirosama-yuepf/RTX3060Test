...
/**
 * @file   pinhole_intrinsic_factor_inl.h
 * @brief  Define the pinhole intrinsic factor
 * @author cuijiashuo@holomatic.com (Jiashuo Cui)
 * @date   2021-10-14
 */

#ifndef HOLO_CALIBRATION_DEV_FACTORS_INTERNAL_PINHOLE_INTRINSIC_FACTOR_INL_H_
#define HOLO_CALIBRATION_DEV_FACTORS_INTERNAL_PINHOLE_INTRINSIC_FACTOR_INL_H_
 ...
 *
 */
class PinholeIntrinsicFactor : public gtsam::NoiseModelFactor2<gtsam::Pose3, gtsam::Vector9>
{
public:
    using Base = gtsam::NoiseModelFactor2<gtsam::Pose3, gtsam::Vector9>;
     ...
     */
    PinholeIntrinsicFactor(gtsam::Point2 const& measure_2d, gtsam::Point3 const& point3d_world,
    ...
    ///@brief Destructor
    ///@brief Destructor
    virtual ~PinholeIntrinsicFactor()
    {
    }
     ...
     * @param[in] intrinsic Intrinsic of camera to be estimated. intrinsic: fx fy cx cy k1 k2 p1 p2 k3
     ...
     */
    virtual gtsam::Vector evaluateError(gtsam::Pose3 const& cTw, gtsam::Vector9 const& intrinsic,
...
#endif  // HOLO_CALIBRATION_DEV_FACTORS_INTERNAL_PINHOLE_INTRINSIC_FACTOR_INL_H_
