...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 * @brief types common to map
 */
using MapPointState = holo::parking::map::MapPointState;
using SemanticLabel = holo::parking::map::SemanticLabel;
using MapPoint      = holo::parking::map::MapPoint;
using MapPointPtr   = holo::parking::map::MapPointPtr;
using Map           = holo::parking::map::Map;
using MapPtr        = holo::parking::map::MapPtr;
using ConstMapPtr   = holo::parking::map::ConstMapPtr;
using Feature       = holo::parking::map::Feature;
using Features      = holo::parking::map::Features;
...
struct AppErrorStatus
{
    ...
    /// @brief input sensor timestamp error
    bool input_timestamp_error;
    ...
    AppErrorStatus(const bool& _feature_point_num_few = 0, const bool& _front_camera_frequency_low = 0,
                   ...
                   const bool& _input_timestamp_error = 0)
      ...
      , input_timestamp_error(_input_timestamp_error)
    {
    }
    ...
    operator uint32_t() const
    {
        return static_cast<uint32_t>(
            ...
            online_mapping_slope_large * 0x00200000 + input_timestamp_error * 0x00400000);
    }
};
