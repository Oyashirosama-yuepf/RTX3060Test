 ...
 * @brief Auto generated code for QuasiDynamicLaneGroup format
 * @author Yuchao Hu (huyuchao@holomatic.com)
 * @date 2022-05-16
 */

#ifndef HOLO_MAP_FORMAT_HFL_QUASI_DYNAMIC_LANE_GROUP_H_
#define HOLO_MAP_FORMAT_HFL_QUASI_DYNAMIC_LANE_GROUP_H_

#include <vector>
#include <unordered_map>

#include <holo/map/proto/hfl/quasi_dynamic_lane_group.pb.h>
...
class  QuasiDynamicLaneGroup: public Base
{
public:
...
private:
    ::std::uint64_t quasi_dynamic_lane_group_id_; 
    ...
    ::std::uint64_t associated_lane_group_id_; 
...
private:
    void DecodeProto(const ::holo::map::proto::hfl::QuasiDynamicLaneGroup& _proto_handler);
    ::holo::map::proto::hfl::QuasiDynamicLaneGroup EncodeProto();

public:
    QuasiDynamicLaneGroup();
    explicit QuasiDynamicLaneGroup(const ::holo::map::proto::hfl::QuasiDynamicLaneGroup& _proto_handler);
    // init all format data
    QuasiDynamicLaneGroup(const ::std::uint64_t _quasi_dynamic_lane_group_id,const ::std::vector<PavementCondition>& _pavement_condition,const ::std::vector<TrafficCondition>& _traffic_condition,const ::std::vector<MapCondition>& _map_condition,const ::std::vector<Geofence>& _geofence_condition,const ::std::vector<::std::uint64_t>& _tile_ids,const ::std::uint64_t _associated_lane_group_id,const Coordinate& _coordinate,const ::std::uint32_t _zone_id,const ::std::uint32_t _extra_zone_id,const bool _south_flag,const ::std::vector<GeoPoint>& _geometry_points,const ::std::map<::std::uint32_t, GeoLine>& _extra_geometry_points);
    ~QuasiDynamicLaneGroup();

    bool operator==(const ::holo::map::format::QuasiDynamicLaneGroup& _other) const;
    QuasiDynamicLaneGroup& operator=(const ::holo::map::proto::hfl::QuasiDynamicLaneGroup& _proto_handler);
    ...
    ::holo::map::proto::hfl::QuasiDynamicLaneGroup GetProtoHandler()
    {
        return EncodeProto();
    }
    ...
    ::std::uint64_t GetQuasiDynamicLaneGroupId() const
    {
        return quasi_dynamic_lane_group_id_;
    }
    void SetQuasiDynamicLaneGroupId(const ::std::uint64_t _quasi_dynamic_lane_group_id)
    {
        quasi_dynamic_lane_group_id_ = _quasi_dynamic_lane_group_id;
    }
    ...
    ::std::uint64_t GetAssociatedLaneGroupId() const
    {
        return associated_lane_group_id_;
    }
    void SetAssociatedLaneGroupId(const ::std::uint64_t _associated_lane_group_id)
    {
        associated_lane_group_id_ = _associated_lane_group_id;
    }
...
typedef ::std::shared_ptr<QuasiDynamicLaneGroup> PtrQuasiDynamicLaneGroup;
typedef const ::std::vector<QuasiDynamicLaneGroup>* ConstRawPtrVecQuasiDynamicLaneGroup;
typedef ::std::vector<QuasiDynamicLaneGroup>* RawPtrVecQuasiDynamicLaneGroup;
typedef ::std::shared_ptr<QuasiDynamicLaneGroup const> ConstPtrQuasiDynamicLaneGroup;
typedef ::std::shared_ptr<::std::vector<QuasiDynamicLaneGroup> const> ConstPtrVecQuasiDynamicLaneGroup;
typedef ::std::unordered_map<::std::uint64_t, PtrQuasiDynamicLaneGroup> HashmapQuasiDynamicLaneGroup;

}  // namespace format
}  // namespace map 
}  // namespace holo

#endif  // HOLO_MAP_FORMAT_HFL_QUASI_DYNAMIC_LANE_GROUP_H_