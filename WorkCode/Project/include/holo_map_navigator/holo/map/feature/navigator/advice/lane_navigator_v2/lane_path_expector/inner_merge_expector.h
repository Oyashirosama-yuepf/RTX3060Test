...
/**
 * @file inner_merge_expector.h
 * @brief Expected is used to recommend lane paths going through certain link
 * @author yuhongbo (yuhongbo@holomatic.com)
 * @date 2022-02-24
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_INNER_MERGE_EXPECTOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_INNER_MERGE_EXPECTOR_H_
...
namespace advice
{
class InnerMergeExpector : public ExpectorBase
{
public:
    InnerMergeExpector(SceneSketchSPtrType scene_sketch);
    virtual ~InnerMergeExpector() = default;
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_INNER_MERGE_EXPECTOR_H_ */