...
/**
 * @file step_expector.h
 * @brief Step expector strategy
 * @author zhengshulei(zhengshulei@holomatic.com)
 * @date 2022-4-7
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_STEP_EXPECTOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_STEP_EXPECTOR_H_
...
namespace advice
{
class StepExpector : public ExpectorBase
{
public:
    StepExpector(SceneSketchSPtrType scene_sketch);
    virtual ~StepExpector() = default;
...
private:
    holo::uint8_t getExpectedLevel();

private:
    DistanceTypeV0 BASIC_EXPECTOR_DISTANCE = 1500.f;
    DistanceTypeV0 STEP_FACTOR_DISTANCE = 500.f;
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_STEP_EXPECTOR_H_ */