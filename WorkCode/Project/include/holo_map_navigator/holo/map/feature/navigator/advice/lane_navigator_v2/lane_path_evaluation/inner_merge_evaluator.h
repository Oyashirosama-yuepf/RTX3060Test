...
#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_INNER_MERGE_EVALUATOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_INNER_MERGE_EVALUATOR_H_
...
namespace advice
{
class InnerMergeEvaluator : public EvaluatorBase
{
public:
    InnerMergeEvaluator(SceneSketchSPtrType scene_sketch);
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_EVALUATION_INNER_MERGE_EVALUATOR_H_ */