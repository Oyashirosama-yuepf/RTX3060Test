...
/**
 * @file jct_terminator.h
 * @brief Terminator is used to stop extending of lane path
 * @author yuhongbo (yuhongbo@holomatic.com)
 * @date 2022-3-23
 */

#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_ANALYSIS_JCT_TERMINATOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_LANE_PATH_ANALYSIS_JCT_TERMINATOR_H_
...
namespace lanepath
{
class JCTTerminator : public TerminatorBase
{
public:
    /**
...
private:
    ...
    holo::bool_t checkHaltLanePathAfterJCT(TerminatorTarget& target);

    //Unit: meter
    Distance const DISTANCE_BETWEEN_CAR_AND_JCT_EXIT = 500.0;
    Distance const DISTANCE_LANE_PATH_GENERATE_ON_JCT_EXIT = 1000.0;
};
