...
#ifndef HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_JCT_EXPECTOR_H_
#define HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_JCT_EXPECTOR_H_
...
namespace advice
{
class JCTExpector : public ExpectorBase
{
public:
    JCTExpector(SceneSketchSPtrType scene_sketch, RouteSceneSPtrType route_scene);
    virtual ~JCTExpector() = default;
...
#endif /* HOLO_MAP_FEATURE_NAVIGATOR_ADVICE_LANE_NAVIGATOR_V2_EXPECT_EVALUATE_EXPECTOR_JCT_EXPECTOR_H_ */