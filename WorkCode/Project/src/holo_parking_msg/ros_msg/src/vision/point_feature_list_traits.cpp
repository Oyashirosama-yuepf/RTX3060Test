                                                                              ...
                                                                              MessageType&     message)
{
    ...
    message.descriptor.resize(value.GetDescriptorDimension());

    for (size_t i = 0; i < value.GetDescriptorDimension(); ++i)
    {
                                                                              ...
                                                                              ValueType&         value)
{
    ...
    desc.reserve(message.descriptor.size());

    for (size_t i = 0; i < message.descriptor.size(); ++i)
    {
