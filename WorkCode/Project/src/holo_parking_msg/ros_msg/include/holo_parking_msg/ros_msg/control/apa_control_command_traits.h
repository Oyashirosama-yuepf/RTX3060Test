...
#ifndef HOLO_PARKING_MSG_ROS_MSG_APA_CONTROL_COMMAND_TRAITS_H_
#define HOLO_PARKING_MSG_ROS_MSG_APA_CONTROL_COMMAND_TRAITS_H_

#include <holo/parking/control/apa_control_command.h>

#include <ros_wrapper/traits.h>

#include <holo_parking_msg/ApaControlCommand.h>
...
template <>
struct DefaultMessageTraits<::holo_parking_msg::ApaControlCommand>
{
    using ValueType = ::holo_parking_msg::ApaControlCommand;
    using MessageType = ::holo_parking_msg::ApaControlCommand;
};
