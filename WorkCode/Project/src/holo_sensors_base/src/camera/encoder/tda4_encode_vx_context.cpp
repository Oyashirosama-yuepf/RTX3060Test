...
/**
 * @file tda4_encode_vx_context.cpp
...
namespace camera
{
std::mutex Tda4EncodeVxContext::mutex_;
int32_t    Tda4EncodeVxContext::refnum_;
vx_context Tda4EncodeVxContext::context_;

Tda4EncodeVxContext::Tda4EncodeVxContext(uint16_t refnum)
{
...
vx_context Tda4EncodeVxContext::GetContext() const noexcept
{
    return context_;
}

Tda4EncodeVxContext::~Tda4EncodeVxContext()
{
    std::lock_guard<std::mutex> guard(mutex_);
    if (--refnum_ == 0)
    {
